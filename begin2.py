...
# n = list(map(int, input()))#функция map можно ввести цифры без пробелов и они будут списком, если вводить так
# print(n)
...
# else:
# 	print("red")
#без остатка и остаток меньше чем 3 то зеленый если больше то красный

#Вложенные условия и множественный выбор!!!!!!!
#в услових могут быть вложены другие условия
# x = int(input())
# if x % 2 == 0:
# 	if 0 <= x <=9:
# 		print("х это цифра")
# 	else:# относится к вложенному условию
# 		print("х это число")
# #на отступы надо внимательно обращать внимание, так как они влияют на вложенность в списках. если например else не там написать, то он будет относиться не тому if и тд
# else:#относится к основному условию
...
# 		m = c
# 		print(c)
#это простой пример вложенных условий. На практике желательно делать до трех вложенных условий не больше, если получается больше то наверно нужно что то переделать в программе, возможно испольщзовать другие конструкции или функции
#множественный выбор!!!
# if item == 1:
# 	print("change Python")
# else:
...
# 		else:
# 			if item == 4:
# 				print("change javascript")
# 			else:
# 				print("неверный пункт")
#или другой вариант с elif это типа else if но покороче, укороченная версис иначе если 
# if item == 1:
# 	print("change Python")
# elif item==2:
# 	print("change C++")
...
# else:
# 	print("неверный пункт")
#будут на одном уровне. Если первое условие не сработает то будет проверяться второе и тд пока какое нибудь из условий невыполнится. Если никакие условие не выполнится, то сработает блок else который идет в конце
#последовательность должна быть именно такая if-elif-else, можно использовать и без else или без elif, но если использовать все три то именно так нужно использовать
#более сложная конструкция
#x = int(input())
#проверим если х положительное, то сколько десятков она будет содержать, либо цифра, либо двухзначное число либо трехзначное
# if x < 0:
