...
# в питоне можно создавать итератор с помощью функции iter, и потом с помощью функции next перебирать итерируемый объект, например список. Это универсальный способ перебрать итерируемый объект
# Как это делается
