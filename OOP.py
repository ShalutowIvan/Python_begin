...
# функция hasattr возвращает тру в случае если аттрибут либо есть в классе или объекте, либо доступен через экземплря объекта в случае если применяем функцию к объекту
...
# # print(a.y)
# print(Point.__doc__)#вывели описание класса на экран. Описание нужно для того чтобы проще было читать код в случае если большой класс пишем со слодной структурой
# итоги
