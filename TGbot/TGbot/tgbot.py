...
# остановился на 25,40. И почему то не работает загрузка фото, точнее не переходит к следующему состоянию. Скорее всего не работает метод где загружается фото, нужно с ним разобраться
